...
$APPLICATION->SetTitle("");?><section class="content__main">
...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_MAIN_BLOCK_OFFERS_PROPERTY_CODE" => array(0=>"ATT_COLOR_PR",1=>"ATT_SURFACE",),
		"DETAIL_MAIN_BLOCK_PROPERTY_CODE" => array(0=>"ATT_SIZE",1=>"ATT_WEIGTH",2=>"ATT_KOLVO",),
		...
		"SEF_FOLDER" => "/catalog/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("sections"=>"","section"=>"#SECTION_CODE_PATH#/","element"=>"#SECTION_CODE_PATH#/#ELEMENT_CODE#/","compare"=>"compare.php?action=#ACTION_CODE#","smart_filter"=>"#SECTION_ID#/filter/#SMART_FILTER_PATH#/apply/",),
		"SET_LAST_MODIFIED" => "Y",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "Y",
