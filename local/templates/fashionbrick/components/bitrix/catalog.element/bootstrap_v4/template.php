							...
							switch ($blockName)
							{
								...
								case 'price':
									...
									<div class="mb-3">
										...
										<div class="product-item-detail-price-current mb-1" id="<?=$itemIds['PRICE_ID']?>idd"><?=$price['PRINT_PRICE']?></div>
                                        <pre>
                                            <?//print_r($price)?>
                                        </pre>

                                        <div class="product-item-current__price mb-1" id="<?=$itemIds['PRICE_ID']?>">Цена за 1 шт.:<?=$price['PRINT_PRICE']?></div>
										<?php
										if ($arParams['SHOW_OLD_PRICE'] === 'Y')
										{
											?>
